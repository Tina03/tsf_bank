...
<body>
    ...
    <class class="welcome">
        <h2>
            <strong>Wel-Come to TSF Banking!!!</strong> 
        </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/bank4.jpg" width="80" height="600" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/bank.jpg" width="40" height="600" class="d-block w-100" alt="...">
