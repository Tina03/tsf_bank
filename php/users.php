...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">TSF BANK <img src="logos/tsf.png" alt="Bank" width="50" height="50"></a>
    ...
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        ...
        <a href="history.php"><button type="button" class="btn btn-dark btn-lg mb-3">View Transaction History</button></a>
    </div>
    </div>
 ...
 <div class="container">
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn btn-outline-dark mb-3" name="submit" type="submit" id="myBtn" >Transfer Money</button>
            </div>
        </form>
    </div>    
